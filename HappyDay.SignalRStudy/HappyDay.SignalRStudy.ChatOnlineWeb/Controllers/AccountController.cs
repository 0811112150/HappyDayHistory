...
using HappyDay.SignalRStudy.ChatOnlineWeb.Filters;
using HappyDay.SignalRStudy.ChatOnlineWeb.Models;

namespace HappyDay.SignalRStudy.ChatOnlineWeb.Controllers
{
	[Authorize]
